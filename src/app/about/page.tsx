      ...
      <main className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="space-y-6 text-sm text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="glass-card p-4">
                <h3 className="text-amber-400 font-semibold mb-1">Live Prices</h3>
              ...
              <div className="glass-card p-4">
                <h3 className="text-amber-400 font-semibold mb-1">AI Predictions</h3>
              ...
              <div className="glass-card p-4">
                <h3 className="text-amber-400 font-semibold mb-1">Global Coverage</h3>
          ...
          <section>
            ...
            <p className="text-amber-400/90">Metal Detector is for informational purposes only and does not constitute financial advice. Predictions are generated by AI models and may be inaccurate. Always do your own research and consult a qualified financial advisor before making investment decisions.</p>
          </section>
